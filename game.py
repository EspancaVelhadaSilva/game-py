...
IMAGEM_CANO = pygame.transform.scale2x(
    pygame.image.load(os.path.join('imgs', 'arvore.png'))
)
...
IMAGEM_BACKGROUND = pygame.transform.scale2x(
    pygame.image.load(os.path.join('imgs', 'floresta.png'))
)

IMAGENS_PASSARO = [
    pygame.transform.scale2x(
        pygame.image.load(os.path.join('imgs', 'ghost1.png'))
    ),
    pygame.transform.scale2x(
        pygame.image.load(os.path.join('imgs', 'ghost2.png'))
    ),
    pygame.transform.scale2x(
        pygame.image.load(os.path.join('imgs', 'ghost3.png'))
    )
]
